...
\begin{basic_box}
    \faIcon[regular]{gem} ¿Qué pasaría si, en lugar de una cola fuese un arreglo? (Ver apunte de Gemas)
\end{basic_box}
...
\begin{basic_box}
    \faIcon[regular]{gem} ¿El siguiente programa, finaliza? (Ver apunte de Gemas)
